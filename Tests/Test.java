...
public class Test {
	...
	public static void main(String[] args) {
		...
		Point3D p6 = new Point3D(-50, -40);
		Point3D p7 = new Point3D(-20, 67);
		Point3D p8 = new Point3D(-90, 80);
		Node n = new Node(0, p);
...
//		g2.init("maorgraph.txt");
		...
		g3.drawShotrestPath(5, 1); //from here and down need to add botooms
		g3.isConnect();
